...
MapGroup_Pewter:
	...
	map Route2Top, TILESET_KANTO, ROUTE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ViridianForest, TILESET_FOREST, ROUTE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Viridian:
	map Route2Bottom, TILESET_KANTO, ROUTE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
